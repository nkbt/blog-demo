...
foreach ($config['servers'] as $i => $server) {
    ...
    $redis = new Redis();
    $redis->connect('tcp://'.$server['host'], $server['port']);
    ...
    <div class="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <div><?php echo $info[$i]['redis_version'] ?></div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div><?php echo format_size($info[$i]['used_memory']) ?></div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div><?php echo format_ago($info[$i]['uptime_in_seconds']) ?></div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <div><?php echo format_ago(time() - $info[$i]['rdb_last_save_time'], true) ?> <a href="save.php?s=<?php echo $i ?>"><img src="images/save.png" width="16" height="16" title="Save Now" alt="[S]" class="imgbut"></a></div>
                </td>
            </tr>
